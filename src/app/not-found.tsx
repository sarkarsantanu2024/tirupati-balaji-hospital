  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-neutral-50">
      <div className="text-center px-4 py-20">
        ...
        <span className="material-symbols-outlined block text-primary-400 mb-6" style={{ fontSize: 48 }}>local_hospital</span>
        <h1 className="text-4xl font-extrabold text-neutral-800 mb-3">Page Not Found</h1>
